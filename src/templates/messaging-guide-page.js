...
export const MessagingGuidePageTemplate = ({ seo, title, subTitle, content, contentComponent }) => {
...
MessagingGuidePageTemplate.propTypes = {
...
const MessagingGuidePage = ({ data }) => {
  const { markdownRemark: post } = data

  return (
    <Layout>
      <MessagingGuidePageTemplate
...
MessagingGuidePage.propTypes = {
  data: PropTypes.object.isRequired,
} 

export default MessagingGuidePage

export const messagingGuidePageQuery = graphql`
  query MessagingGuidePage($id: String!) {
